...
// -----> Base layer <-----
    [_BASE] = LAYOUT(
        ...
        OS_RSFT, KC_Z,  KC_X,  KC_C,  KC_D,  KC_V, KC_MUTE, /**/ KC_MUTE, KC_K,  KC_H, KC_COMM, KC_DOT, KC_SLSH, LT(4,KC_APP),
...
// -----> Extend layer <-----
    [_EXT] = LAYOUT(
        ...
        _______,  KC_ESC, LCS(KC_TAB),  KC_TAB,  C(KC_TAB), QK_AREP, KC_MPLY, /**/ KC_MPLY,  QK_REP,  OS_LCS,     KC_ENT,  KC_APP,   KC_PSCR, XXXXXXX,
...
// -----> Symbols layer <-----
    [_SYM] = LAYOUT(
      ...
      LCA(KC_4),  KC_DLR, KC_PLUS, KC_RPRN, KC_RCBR, KC_RBRC, KC_MUTE, /**/ KC_MUTE, KC_CIRC, KC_PIPE,   KC_LT,   KC_GT, KC_BSLS, XXXXXXX,
...
// -----> Adjust and Function layer <-----
    [_ADJFN] = LAYOUT(
        ...
        XXXXXXX, KC_MSTP, KC_MPRV, KC_MPLY, KC_MNXT,   TG(5), KC_MUTE, /**/ KC_MUTE, KC_F10,   KC_F1,   KC_F2,   KC_F3, KC_SCRL,   TG(5),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_ADJFN] = { ENCODER_CCW_CW(KC_PGUP, KC_PGDN),           ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [_WKNM]  = { ENCODER_CCW_CW(C(KC_PGUP), C(KC_PGDN)),     ENCODER_CCW_CW(LCS(KC_TAB), C(KC_TAB)) },
...
bool get_hold_on_other_key_press(uint16_t keycode, keyrecord_t *record) {
    return IS_QK_ONE_SHOT_LAYER(keycode) || keycode == LT(4,KC_APP);
}
