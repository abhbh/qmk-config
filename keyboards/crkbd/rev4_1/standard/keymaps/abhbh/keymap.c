...
// -----> Base layer <-----
    [0] = LAYOUT_split_3x6_3_ex2(
        ...
        OSM(MOD_RSFT), KC_Z, KC_X, KC_C, KC_D, KC_V, /* //////-------------\\\\\\ */ KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, LT(5,KC_APP),
                               OSM(MOD_LCTL), OSL(1), KC_SPC, /* /-----\ */ OSM(MOD_LSFT), OSL(2), OSM(MOD_LGUI)),
...
// -----> Workspace Management and Numpad layer <-----
    [5] = LAYOUT_split_3x6_3_ex2(
        KC_TRNS, C(G(KC_1)),   C(G(KC_2)), C(G(KC_3)),   C(G(KC_4)), C(G(KC_5)), KC_TRNS, /* |-----| */ KC_TRNS, KC_PAST,  KC_P7, KC_P8, KC_P9, KC_PMNS, KC_TRNS,
        KC_TRNS, C(G(KC_6)),   C(G(KC_7)), C(G(KC_8)),   C(G(KC_9)), C(G(KC_0)), KC_TRNS, /* |-----| */ KC_TRNS,   KC_P0,  KC_P4, KC_P5, KC_P6, KC_PPLS, KC_TRNS,
        KC_TRNS,     KC_ESC, LSG(KC_LEFT),     KC_TAB, LSG(KC_RGHT),  A(KC_ESC), /* /////---------------\\\\\ */ KC_PSLS,  KC_P1, KC_P2, KC_P3, KC_PDOT,   TG(5),
